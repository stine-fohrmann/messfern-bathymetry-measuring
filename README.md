...
- [x] 2. Determine research vessel navigation plan
    - [x] compute how long it took (assuming speed of 10 kts)
- [x] 3. Take measurements
- [x] 4. Draw contour map
    ...
    - [x] include units
- [x] 5. Cost
    - [x] estimate how much it cost, assuming
    - speed of 10 kts
    - 24h work days
